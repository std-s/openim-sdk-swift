...
public struct Group: Interface {
    public func addListener(listener: OnGroupListener) {
        ListenerManager.shared.addListener(listener)
    }
    
    public func removeListener(listener: OnGroupListener) {
    ...
    /// Get group request
    public func getGroupRequest(_ req: GetGroupRequestReq) async throws -> [IMGroupApplication] {
        let result = try await Utils.callCoreAPI(funcName: .getGroupRequest, req: req) as GetGroupRequestResp
    ...
    public func handlerGroupRequest(_ req: HandlerGroupRequestReq) async throws {
        try await Utils.callCoreAPI(funcName: .handlerGroupRequest, req: req) as HandlerGroupRequestResp
    }
}
